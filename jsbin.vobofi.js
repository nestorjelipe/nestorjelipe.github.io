...
var myCenter = new L.LatLng(52.8, 13.5);

var map = new L.Map('map', {attributionControl: false, center: myCenter, zoom: 16, maxBounds: L.latLngBounds([[54.41281,11.28821],[50.5589,14.63805]]).pad(0.5)});
